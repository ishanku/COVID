  ...
  CovidData.forEach((covidReport) => {
    ...
    var allcities=covidReport.region.cities; 
     ...
     for (let city =0; city < allcities.length; city++){
		// console.log("AllCities" + covidReport.region.cities[city].name);
    var customPopup = "<h3>" + covidReport.region.cities[city].name + "</h3><p>Date:" + cdate + "</p><hr><p>New Losses: +" + covidReport.region.cities[city].deaths_diff + "</p><p>Total Losses: +"  + covidReport.region.cities[city].deaths + "</p><p>New Cases: "+ covidReport.region.cities[city].confirmed_diff + "</p><p>Total Cases: +"+ covidReport.region.cities[city].confirmed + "</p>";
	var latitude=covidReport.region.cities[city].lat;
    var longitude= covidReport.region.cities[city].long;
